...
.NOTES
    This script is intended for use with the powershell-7-help skill as a
...
if ($help -is [System.Management.Automation.ErrorRecord] -or ($help.PSTypeNames -contains 'System.Management.Automation.ErrorRecord')) {
