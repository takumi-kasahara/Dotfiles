...
if [ "$color_prompt" = yes ]; then
  PS1='${debian_chroot:+($debian_chroot)}\[\e[1;32m\]\u@\h\[\e[00m\] \[\e[1;35m\]${WSL_DISTRO_NAME:-$OSTYPE} \[\e[1;33m\]\w\[\e[00m\]\n\$ '
else
  PS1='${debian_chroot:+($debian_chroot)}\u@\h ${WSL_DISTRO_NAME:-$OSTYPE} \w\n\$ '
fi
